        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
            <asp:GridView ID="gridviewProductos" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnPageIndexChanging="gridviewProductos_PageIndexChanging" AutoGenerateEditButton="True" OnRowEditing="gridviewProductos_RowEditing" OnRowUpdating="gridviewProductos_RowUpdating" OnRowCancelingEdit="gridviewProductos_RowCancelingEdit" AutoGenerateDeleteButton="True" OnRowDeleting="gridviewProductos_RowDeleting">
                <Columns>
